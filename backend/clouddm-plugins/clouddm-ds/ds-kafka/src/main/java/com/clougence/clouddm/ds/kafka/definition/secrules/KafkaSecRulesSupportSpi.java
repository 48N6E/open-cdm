 ...
 */
package com.clougence.clouddm.ds.kafka.definition.secrules;
...
public class KafkaSecRulesSupportSpi implements SecRulesSupportSpi {
    ...
    public List<TargetType> supportModel() {
        return Arrays.asList(TargetType.Schema, TargetType.Table, TargetType.Query);
    }
