...
public class CrdbUmiServiceDm extends AbstractRdbUmiService<CrdbMetaProviderDm> implements RdbUmiServiceDm {

    public CrdbUmiServiceDm(Connection con){
        super(() -> new CrdbMetaProviderDm(con));
    }
