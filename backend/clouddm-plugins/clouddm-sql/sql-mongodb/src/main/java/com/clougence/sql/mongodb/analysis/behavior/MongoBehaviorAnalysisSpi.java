...
public class MongoBehaviorAnalysisSpi implements BehaviorAnalysisSpi {
    ...
    private SplitQueryType statementType(MongoFuncType type) {
        return switch (type) {
            ...
            case LIST_COLLECTIONS, LIST_INDEXES, SHOW_DATABASES, SHOW_COLLECTIONS, RS_STATUS, RS_CONF, RS_REPLICATION_INFO, RS_PRINT_SECONDARY_REPLICATION_INFO, SH_STATUS, SH_BALANCER_STATUS -> SplitQueryType.METADATA;
    ...
    private BehaviorAction action(MongoFuncType funcType, SplitQueryType type) {
        BehaviorAction commandAction = switch (funcType) {
            ...
            case HOST_INFO, CURRENT_OP, SERVER_STATUS, BUILD_INFO, GET_LOG_COMPONENTS, DB_STATS, LATENCY_STATS, RS_STATUS, RS_CONF, RS_REPLICATION_INFO, RS_PRINT_SECONDARY_REPLICATION_INFO, SH_STATUS, SH_BALANCER_STATUS -> BehaviorAction.READ;
            default -> null;
        };
